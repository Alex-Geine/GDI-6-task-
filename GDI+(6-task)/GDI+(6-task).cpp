...
// GDI+(6-task).cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CGDI6taskApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CGDI6taskApp

CGDI6taskApp::CGDI6taskApp()
{
...
// Единственный объект CGDI6taskApp

CGDI6taskApp theApp;


// Инициализация CGDI6taskApp

BOOL CGDI6taskApp::InitInstance()
{
